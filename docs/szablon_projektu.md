...
Sindbad/
  ...
  logic/               logika aplikacji: baza, modele, walidacja, maile, testy
...
```text
auth           typy autoryzacji
booking        typy rezerwacji
certification  typy certyfikatów
comment        typy komentarzy i statystyk opinii
email          typy maili
form           typy formularzy
image          typy obrazków
offer          typy ofert i rejsów
tripAlert      typy powiadomień o rejsach
user           typy użytkownika
```
